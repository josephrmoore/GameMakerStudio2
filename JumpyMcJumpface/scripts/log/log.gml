...
show_debug_message("**************BEGIN*CONSOLE*************");
if (argument_count > 1){
    var label = argument[1];
	show_debug_message(string("Label: " + string(label)));
}
show_debug_message("variable type:");
if(is_array(n)){
...
} else if (ds_exists(n, ds_type_grid)){
...
show_debug_message("===============END=CONSOLE===============");